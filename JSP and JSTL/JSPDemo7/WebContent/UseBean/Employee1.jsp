...
<jsp:setProperty name="emp" property="empId"  param="empId"/>
<jsp:setProperty name="emp" property="empName" value="<%=empName%>" />
<jsp:setProperty name="emp" property="salary" value="<%=salary%>"/>
<jsp:setProperty name="emp" property="bonus"  param="bonus"/>
